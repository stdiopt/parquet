...
// keyValue Record Map keyValue pair.
...
// unmarshal converts the table map to objects slice. dstInterface is a slice of pointers of objects.
func unmarshal(
	tableMap *map[string]*layoutTable,
	bgn int,
	end int,
	...
	tableNeeds := make(map[string]*layoutTable)
	...
	prefixIndex := pathStrIndex(prefixPath) - 1
