...
func TestCmpIntBinary(t *testing.T) {
	...
	for _, c := range cases2 {
		as, err := strIntToBinary(c.numa, "LittleEndian", 0, true)
		if err != nil {
			t.Fatal(err)
		}
		bs, err := strIntToBinary(c.numb, "LittleEndian", 0, true)
		if err != nil {
			t.Fatal(err)
		}
		an, bn := 0, 0
	...
	for _, c := range cases3 {
		as, err := strIntToBinary(c.numa, "LittleEndian", 0, false)
		if err != nil {
			t.Fatal(err)
		}
		bs, err := strIntToBinary(c.numb, "LittleEndian", 0, false)
		if err != nil {
			t.Fatal(err)
		}
...
func TestCmp(t *testing.T) {
	cases := []struct {
		...
		{
			"int96 1", mustV(strIntToBinary("2147483648", "LittleEndian", 12, true)),
			mustV(strIntToBinary("2147483647", "LittleEndian", 12, true)), parquet.TypePtr(parquet.Type_INT96), nil, false,
		},
		{
			"int96 2", mustV(strIntToBinary("-2147483648", "LittleEndian", 12, true)),
			mustV(strIntToBinary("-2147483647", "LittleEndian", 12, true)), parquet.TypePtr(parquet.Type_INT96), nil, true,
		},
		...
		{
			"utf8 1", string("abc bcd"), string("abc"),
			parquet.TypePtr(parquet.Type_BYTE_ARRAY),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UTF8), false,
		},
		{
			"utf8 2", string("abc"), string("abc"),
			parquet.TypePtr(parquet.Type_BYTE_ARRAY),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UTF8), false,
		},
		{
			"utf8 3", string("abc"), string("abc def"),
			parquet.TypePtr(parquet.Type_BYTE_ARRAY),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UTF8), true,
		},

		{
			"int_8 1", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_INT_8), true,
		},
		{
			"int_8 2", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_INT_16), true,
		},
		{
			"int_8 3", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_INT_32), true,
		},
		{
			"int_8 4", int64(1), int64(2),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_INT_64), true,
		},

		{
			"uint_8 1", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_8), true,
		},
		{
			"uint_8 2", int32(1), int32(-2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_8), true,
		},
		{
			"uint_8 3", int32(-1), int32(-2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_8), false,
		},
		{
			"uint_8 4", int32(-2), int32(-1),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_8), true,
		},
		{
			"uint_16 1", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_16), true,
		},
		{
			"uint_16 2", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_32), true,
		},
		{
			"uint_16 3", int64(1), int64(2),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_UINT_64), true,
		},

		{
			"date 1", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_DATE), true,
		},
		{
			"time_millis 1", int32(1), int32(2),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_TIME_MILLIS),
			true,
		},
		{
			"time_micros 1", int64(1), int64(2),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_TIME_MICROS),
			true,
		},
		{
			"timestamp_micros 1", int64(1), int64(2),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_TIMESTAMP_MICROS),
			true,
		},
		{
			"timestamp_millis 1", int64(1), int64(2),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_TIMESTAMP_MILLIS),
			true,
		},

		{
			"interval 1", mustV(strIntToBinary("12345", "LittleEndian", 12, false)),
			mustV(strIntToBinary("123456", "LittleEndian", 12, false)),
			parquet.TypePtr(parquet.Type_FIXED_LEN_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_INTERVAL), true,
		},
		{
			"interval 2", mustV(strIntToBinary("123457", "LittleEndian", 12, false)),
			mustV(strIntToBinary("123456", "LittleEndian", 12, false)),
			parquet.TypePtr(parquet.Type_FIXED_LEN_BYTE_ARRAY), parquet.ConvertedTypePtr(parquet.ConvertedType_INTERVAL), false,
		},

		{
			"decimal 1", int32(12345), int32(123),
			parquet.TypePtr(parquet.Type_INT32),
			parquet.ConvertedTypePtr(parquet.ConvertedType_DECIMAL),
			false,
		},
		{
			"decimal 2", int64(12345), int64(12346),
			parquet.TypePtr(parquet.Type_INT64),
			parquet.ConvertedTypePtr(parquet.ConvertedType_DECIMAL), true,
		},

		{
			"decimal 3",
			mustV(strIntToBinary("12345", "BigEndian", 0, true)),
			mustV(strIntToBinary("12346", "BigEndian", 0, true)),
